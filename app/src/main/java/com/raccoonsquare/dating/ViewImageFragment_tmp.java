...
import com.raccoonsquare.dating.adapter.CommentListAdapter;
...
public class ViewImageFragment_tmp extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener, CommentInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSendComment = rootView.findViewById(R.id.sendCommentImg);
        ...
        mItemAuthorPhoto = mListViewHeader.findViewById(R.id.itemAuthorPhoto);
        mItemAction = mListViewHeader.findViewById(R.id.itemAction);
        mItemLike = mListViewHeader.findViewById(R.id.itemLike);
        mItemComment = mListViewHeader.findViewById(R.id.itemComment);

        mItemAuthor = mListViewHeader.findViewById(R.id.itemAuthor);
        mItemUsername = mListViewHeader.findViewById(R.id.itemUsername);
        mItemMode = mListViewHeader.findViewById(R.id.itemMode);
        mItemText = mListViewHeader.findViewById(R.id.itemText);
        mItemTimeAgo = mListViewHeader.findViewById(R.id.itemTimeAgo);
        mItemLikesCount = mListViewHeader.findViewById(R.id.itemLikesCount);
        mItemCommentsCount = mListViewHeader.findViewById(R.id.itemCommentsCount);
        mItemCity = mListViewHeader.findViewById(R.id.itemCity);
        mItemCountry = mListViewHeader.findViewById(R.id.itemCountry);
        mItemLocationContainer = mListViewHeader.findViewById(R.id.locationContainer);
        mItemImg = mListViewHeader.findViewById(R.id.itemImg);

        mItemHeader = mListViewHeader.findViewById(R.id.itemHeader);
        mItemContent = mListViewHeader.findViewById(R.id.itemContent);
        mItemFooter = mListViewHeader.findViewById(R.id.itemFooter);

        mItemPlay = mListViewHeader.findViewById(R.id.itemPlay);
