...
import com.raccoonsquare.dating.util.TagSelectingTextview;
...
public class CommentListAdapter extends BaseAdapter implements Constants {
	...
	public CommentListAdapter(FragmentActivity activity, List<Comment> commentsList, CommentInterface responder) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            viewHolder.commentAuthorPhoto = convertView.findViewById(R.id.commentAuthorPhoto);
            viewHolder.commentImg = convertView.findViewById(R.id.commentImg);
            viewHolder.commentLike = convertView.findViewById(R.id.commentLike);
            viewHolder.commentAction = convertView.findViewById(R.id.commentAction);
            viewHolder.commentLikesCount = convertView.findViewById(R.id.commentLikesCount);
			viewHolder.commentText = convertView.findViewById(R.id.commentText);
            viewHolder.commentAuthor = convertView.findViewById(R.id.commentAuthor);
            viewHolder.commentTimeAgo = convertView.findViewById(R.id.commentTimeAgo);
