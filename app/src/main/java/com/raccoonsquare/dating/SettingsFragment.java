...
public class SettingsFragment extends PreferenceFragmentCompat implements Constants {
    ...
    private Preference logoutPreference, itemContactUs, aboutPreference, changePassword, itemReferralsList, itemRefillList, itemBalance, itemBalanceHistory, itemServices, itemTerms, itemThanks, itemBlackList, itemNotifications, itemDeactivateAccount, itemPrivacy;
