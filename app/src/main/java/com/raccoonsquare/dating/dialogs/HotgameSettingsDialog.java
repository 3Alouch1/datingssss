package com.raccoonsquare.dating.dialogs;
...
public class HotgameSettingsDialog extends DialogFragment implements Constants {
    ...
    public interface AlertPositiveListener {
        ...
        void onCloseHotgameSettingsDialog(int searchGender, int searchSexOrientation, int liked, int matches);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        genderMaleCheckBox = view.findViewById(R.id.genderMaleCheckBox);
        genderFemaleCheckBox = view.findViewById(R.id.genderFemaleCheckBox);

        likedCheckBox = view.findViewById(R.id.likedCheckBox);
        matchesCheckBox = view.findViewById(R.id.matchesCheckBox);

        sexOrientationSpinner = view.findViewById(R.id.sexOrientationSpinner);
